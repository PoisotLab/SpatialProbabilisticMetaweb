...
occ <- read_tsv("./xtras/occurrences/all_occurrences.csv") # works now??

# Create a smaller data set
write_csv(head(occ), "xtras/occurrences/all_occurrences_mini.csv")

# Try to reexport
write_tsv(head(occ, 100000), "xtras/occurrences/all_occurrences2.csv")

# Check exported dataset
occ2 <- read_tsv("./xtras/occurrences/all_occurrences2.csv") # wrong number of rows??
...
problem_occ
write_tsv(problem_occ, "./xtras/occurrences/all_occurrences_problems.csv")

# Re-read problems?
occ3 <- read_tsv("./xtras/occurrences/all_occurrences_problems.csv")
